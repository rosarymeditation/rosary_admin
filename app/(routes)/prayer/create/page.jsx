...
const page = ({ params }) => {
  ...
  const loadData = (id) => {
    GlobalApi.novenaById({
      id,
    }).then((resp) => {
      console.log(resp.data);
      const novena = resp.data.data;
      setTitle(novena.title);
      setContent(novena.content);
      setUrl(novena.url);
      setSelectedType(novena.type);
      setSelectedLanguage(novena.language);
      setId(id);
      console.log(novena);
  ...
  const handleUpdate = (e) => {
    ...
    GlobalApi.createPrayer(formData).then((result) => {
