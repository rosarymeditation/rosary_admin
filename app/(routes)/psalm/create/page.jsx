...
export default function PsalmCreatePage() {
  ...
  const handleCreate = () => {
    ...
    setIsLoading(true);
    GlobalApi.createPsalm(formData)
      .then((result) => {
        if (!result.data.error) {
          toast.success("Psalm created successfully.");
  ...
  return (
    <>
      <Head><title>Create Psalm</title></Head>
      ...
      <div className="cp-root">
        <div className="cp-layout">
          ...
          <div className="cp-nav">
            ...
            <span className="cp-badge">New Psalm</span>
          </div>

          {/* ── Main ── */}
          <div className="cp-main">
            <div className="cp-main-header">
              <h1 className="cp-heading">Create Psalm</h1>
              <p className="cp-subheading">Add a new psalm to the collection</p>
            </div>
          ...
          <div className="cp-sidebar">
            ...
            <div className="cp-panel">
              <div className="cp-panel-body" style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                ...
                <p className="cp-hint">Title, verse, content &amp; language required.<br />Audio is optional.</p>
              </div>
            </div>
